...
class Atendimento(db.Model):
    ...
    id_pet = db.Column(UUID(as_uuid=True), db.ForeignKey("public.pets.id"), nullable=False) 
    id_veterinario = db.Column(UUID(as_uuid=True), db.ForeignKey("public.usuarios.id"), nullable=False)
    id_clinica = db.Column(UUID(as_uuid=True), db.ForeignKey("public.clinicas.id"), nullable=False)
